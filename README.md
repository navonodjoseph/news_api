...
### Next steps
There is still a lot that can be done to improve this app. I'd like to build in a search feature that would let you search the NYT database. I'm also interested in experimenting with the NYT large RSS library to see if I could include a page that fetches all stories related to a single topic like soccer or finance. 
